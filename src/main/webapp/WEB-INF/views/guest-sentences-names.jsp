...
//             console.log(inputAnswerList[i].dataset.rightanswer);
//             console.log(inputAnswerList[i].value)
    ...
    // добавить цикл inputAnswerList
    //console.log(inputAnswerList[0].dataset.rightanswer) //сравнить с console.log(inputAnswerList[0].value). отрезать пробелы
   // console.log(inputAnswerList[0].value)
